...
@Component
public class ProjectOperationalControlLinkGenerationCronjob {
	...
	public void sendPreparerEmailWithExternalApi() {
	    try {
	        ...
	        String baseURL = "http://182.184.52.88:8122/api/projects/operational-control/email";
	...
	public void sendReviwerEmailWithExternalApi() {
	    try {
	        // Define the Base URL for the send-email endpoint with the path variable
	        String baseURL = "http://182.184.52.88:8122/api/api/projects/operational-control/email";
